# Structured output bridges the gap between human-like language generation and making the llms work with external tools
# uses :
# interact directly with databases, apis, building agents
